...
public class InsertDB2 {
    ...
    public static void InsertRequest(String USREQNO, String USLINE, String USCOMP, String USNAME1, String USNAME2, String USCODE, String USMAIL, String USGROUP,
            String USTYPE, String USLIKE, String USAFUNC, String USDFUNC, String USUREQ, String USEMCRE,String USGROUPAPP,String USAPP,String USROLE) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                String query = "INSERT INTO " + dbname + ".USR_REQUEST\n"
                        ...
                        + "'0', ' ', '0', ' ', '00', '" + USEMCRE + "', '" + USAPP + "', '" + USGROUPAPP + "', '" + USROLE + "')";
     ...
     public static void InsertMailLog(String eddocument, String edrefno, String esentto, String esentcc, String esentfrom,
        ...
        try {
            if (conn != null) {
                ...
                Statement stmt = conn.createStatement();
                String query = "INSERT INTO " + dbname + ".M3_STORAGEEMAILSEND (EDDOCUMENT, EDREFNO, ESENTTO, ESENTCC, ESENTFROM, EDSUBJECT, EDDETAIL, CREATEBY, ECONO,EDPUBKEY, EDPRIKEY, SENTDATE , SENTTIME  )\n" +
