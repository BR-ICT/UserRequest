...
//            Updateheadrequest(reqno, DATENOW, cono, divi, Appname);
    ...
    public static void Sendmail_User(String Emailuser, String LinkAcknow, String SubjectEmail, String Datenow, String USREQNO, String USCREBY, String USLINE) {
        ...
        try {
            ...
            UpdateAcknowledge(USREQNO, Datenow, USCREBY, USLINE);
        } catch (MessagingException e) {
            throw new RuntimeException(e);
        }
    ...
    private static void UpdateAcknowledge(String USREQNO, String Datenow, String USCREBY, String USLINE) {
