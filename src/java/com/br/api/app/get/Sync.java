...
//        System.out.println("page = " + request.getParameter("page"));
        ...
        try {
            ...
            if (request.getParameter("page").equals("Company")) {
            ...
            } else if (request.getParameter("page").equals("authorizedisplay")) {
                try {
                    out.print(SelectDB2.authorizedisplay(request.getParameter("USUREQ")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            } else if (request.getParameter("page").equals("checkExistRole")) {
                try {
                    out.print(SelectDB2.checkExistRole(request.getParameter("cono"), request.getParameter("usercode"),
                            request.getParameter("app"), request.getParameter("groupapp"),
                             request.getParameter("role"), request.getParameter("mode"), request.getParameter("apporrep")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else if (request.getParameter("page").equals("getCompany")) {
                try {
                    out.print(SelectDB2.getCompany());
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else if (request.getParameter("page").equals("getRole")) {
                try {
                    out.print(SelectDB2.getRole(request.getParameter("isitGroupby"),
                            request.getParameter("isitAppby"),
                            request.getParameter("Groupby"),
                            request.getParameter("Appby")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else if (request.getParameter("page").equals("getGroupapp")) {
                try {
                    out.print(SelectDB2.getGroupapp(request.getParameter("authorreport")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                try {
                    ...
                    out.print(SelectDB2.Data_Acknowledge(request.getParameter("USREQNO")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
...
//                    System.out.println("MailCreator");
            ...
            } else if (request.getParameter("page").equals("getAppname")) {
                try {
                    System.out.println("getAppname");
                    out.print(SelectDB2.getAppname(request.getParameter("authorreport")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
...
//                    System.out.println("Check_Duplicate");
                    out.print(SelectDB2.Check_Duplicate(request.getParameter("USREQNO"),
                            request.getParameter("USCOMP"),
                            request.getParameter("USCODE"),
                            request.getParameter("USGROUP"),
                            request.getParameter("USTYPE"),
                            request.getParameter("USGROUPAPP"),
                            request.getParameter("USAPP"),
                            request.getParameter("USROLE")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (request.getParameter("page").equals("InsertRequest")) {
                try {
                    ...
                    InsertDB2.InsertRequest(request.getParameter("USREQNO"), request.getParameter("USLINE"), request.getParameter("USCOMP"), request.getParameter("USNAME1"), request.getParameter("USNAME2"),
                            ...
                            request.getParameter("USAFUNC"), request.getParameter("USDFUNC"), request.getParameter("USUREQ"), request.getParameter("USEMCRE"), request.getParameter("USGROUPAPP"), request.getParameter("USAPP"), request.getParameter("USROLE"));
                } catch (Exception e) {
                ...
                UpdateDB2.Update_LineReq(request.getParameter("USREQNO"), request.getParameter("USLINE"), request.getParameter("USCOMP"), request.getParameter("USNAME1"),
                        ...
                        request.getParameter("USLIKE"), request.getParameter("USAFUNC"), request.getParameter("USDFUNC"), request.getParameter("USEMCRE"), request.getParameter("USGROUPAPP"), request.getParameter("USAPP"), request.getParameter("USROLE"));
                ...
                UpdateDB2.Acknowledge(request.getParameter("USREQNO"), request.getParameter("USACKBY"));
