...
public class UpdateDB2 {
    ...
    public static void UpdateREQ(String username, String REQNO) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                String query = "  UPDATE " + dbname + ".USR_REQUEST\n"
    ...
    public static void Update_LineReq(String USREQNO, String USLINE, String USCOMP, String USNAME1, String USNAME2,
            String USMAIL, String USCODE, String USGROUP, String USTYPE, String USLIKE, String USAFUNC, String USDFUNC, String USEMCRE, String USGROUPAPP, String USAPP, String USROLE) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                String query = "UPDATE " + dbname + ".USR_REQUEST\n"
                        ...
                        + ",USAPP = '" + USAPP + "',USGROUPAPP = '" + USGROUPAPP + "', USROLE = '" + USROLE + "'\n"
    ...
    public static void Acknowledge(String USREQNO, String USACKBY) throws Exception {
